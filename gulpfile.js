...
function cssmin() {
  ...
  .pipe(cleanCSS())
  .pipe(dest('dist/source-files/marvio-css-min-files/'))
}
...
function cssexp() {
  ...
  .pipe(dest('dist/source-files/marvio-css-files/'))
}
...
function libsexp() {
  ...
  .pipe(concat('libs.js'))
  .pipe(dest('dist/source-files/marvio-js-files/'))
}
...
// build function
exports.build         = series(cleandist, styles, cssmin, cssexp, html, libs, libsexp, iesupport, buildcopy, buildalljs);
